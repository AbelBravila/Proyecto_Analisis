...
// Route::get('/', function () {
    ...
    */
    ...
    Route::view('/acceso-denegado', 'acceso_denegado')->name('acceso.denegado');
    
    Route::middleware(['auth', 'verificar.nivel:1'])->group(function () {
    ...
    Route::middleware(['auth', 'verificar.nivel:1,2'])->group(function () {
        // Proveedor (Isaac)
    ...
    Route::middleware(['auth', 'verificar.nivel:1,2,3'])->group(function () {
        // Cliente
