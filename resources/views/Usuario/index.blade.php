<x-admin-layout>
    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
        ...
        <b>
            <h1 class="text-lg text-center dark:text-black">USUARIOS</h1>
        </b>

        <form method="GET" action="{{ route('Usuario') }}" class="mb-4">
            ...
            @foreach ($usuarios as $usuario)
                <tr>
                    ...
                    <a class="fa fa-pencil fa-lg font-medium text-blue-600 dark:text-blue-500 hover:underline"
                                ...
                                data-modal-toggle="editar-modal-usuario-{{ $usuario->id_usuario }}"
                                class="text-blue-600">
                    </a>
                    <a class="fa fa-trash fa-lg font-medium text-blue-600 dark:text-blue-500 hover:underline"
                                href="{{ route('Usuario.cambiar_estado', ['id' => $usuario->id_usuario]) }}"
                                onclick="return confirm('¿Estás seguro de que deseas eliminar este usuario?')">
                    </a>
                    </td>
                </tr>

                <div id="editar-modal-usuario-{{ $usuario->id_usuario }}" tabindex="-1"
                        aria-hidden="true"
                        ...
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                ...
                                <div
                                    ...
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Editar Usuario
                                    </h3>
                                    <button type="button"
                                ...
                                <!-- Modal body -->
                                <form
                                    action="{{ route('Usuario.actualizar_usuario', $usuario->id_usuario) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <input type="text" id="numero" name="numero"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                required
                                                value="{{ old('numero', $usuario->telefono) }}">
                                            @error('correo')
                                                <span class="error text-red-500 text-sm">{{ $message }}</span>
                                            @enderror
                                        </div>
