<x-admin-layout>
    <b>
        <h1 class="text-lg text-center dark:text-black">CAJAS</h1>
    </b>
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            <label for="nombre_proveedor"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre Caja</label>
                    ...
                    <tr>
                        ...
                        <td scope="col" class="px-6 py-3 dark:text-black">
                            <a class="fa fa-pencil fa-lg font-medium text-blue-600 dark:text-blue-500 hover:underline"
                                data-modal-target="editar-modal-cajas-{{ $caja->id_caja }}"
                                data-modal-toggle="editar-modal-cajas-{{ $caja->id_caja }}" class="text-blue-600"></a>
                            <a class="fa fa-trash fa-lg font-medium text-blue-600 dark:text-blue-500 hover:underline"
                                href="{{ route('cajas.cambiar_estado', ['id' => $caja->id_caja]) }}"
                                onclick="return confirm('¿Estás seguro de que deseas eliminar esta caja?')"></a>
                        </td>
                    </tr>

                    <div id="editar-modal-cajas-{{ $caja->id_caja }}" tabindex="-1" aria-hidden="true"
                        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            <!-- Modal content -->
                            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
