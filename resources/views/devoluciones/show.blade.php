<x-admin-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
            ...
            <div class="space-y-2 dark:text-white">
                ...
                <p><span class="font-semibold">Monto Total:</span> Q{{ number_format($devolucion->detalles->sum(function($item) { return $item->cantidad * $item->costo; }), 2) }}</p>
            </div>
        </div>
    </div>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4">
                        Q{{ number_format($detalle->costo, 2) }}
                    </td>
                    <td class="px-6 py-4 font-semibold">
                        Q{{ number_format($detalle->cantidad * $detalle->costo, 2) }}
                    </td>
                </tr>
                @endforeach
                <tr class="bg-gray-100 dark:bg-gray-700 font-bold">
                    ...
                    <td class="px-6 py-4">Q{{ number_format($devolucion->detalles->sum(function($item) { return $item->cantidad * $item->costo; }), 2) }}</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="mt-6 flex justify-end">
        ...
        <a href="{{ route('devoluciones.pdf', $devolucion->id_devolucion) }}" 
