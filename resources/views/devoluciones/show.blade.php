            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 font-semibold">
                        ${{ number_format($detalle->cantidad * $detalle->costo, 2) }}
                    </td>
                </tr>
                @endforeach
                <tr class="bg-gray-100 dark:bg-gray-700 font-bold">
                    ...
                    <td class="px-6 py-4">${{ number_format($devolucion->detalles->sum(function($item) { return $item->cantidad * $item->costo; }), 2) }}</td>
                </tr>
            </tbody>
        </table>
    </div>
