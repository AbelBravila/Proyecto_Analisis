...
<head>
    <meta charset="UTF-8">
    <title>Devolución #{{ $devolucion->id_devolucion }}</title>
    <style>
...
<body>
    ...
    <h2>Detalle de Devolución de Compra #{{ $devolucion->id_devolucion }}</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: right;"><span class="currency">Q{{ number_format($detalle->costo, 2) }}</span></td>
                <td style="text-align: right;"><span class="currency">Q{{ number_format($detalle->cantidad * $detalle->costo, 2) }}</span></td>
            </tr>
            @endforeach
            <tr class="total-row">
                <td colspan="4"><strong>TOTAL GENERAL</strong></td>
                <td style="text-align: right;"><strong><span class="currency">Q{{ number_format($devolucion->detalles->sum(function($item) { return $item->cantidad * $item->costo; }), 2) }}</span></strong></td>
            </tr>
        </tbody>
    </table>
</body>
